...
(s/defschema ProductInfo
  {
   ...
   :title s/Str
   :note s/Str
   :shortDescription s/Str
   :longDescription s/Str
   :attributes {s/Str s/Str}
   :pictures [Url]
